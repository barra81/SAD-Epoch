...
_vehicleIdStr = _vehicle getVariable ["CharacterID",0];
_vehicleID = parseNumber _vehicleIdStr;

//["conGreen",format ["_vehicleID = %1", _vehicleID]] call diagLog;
...
if (_tradeCancel) exitWith { tfv_IS_TRADING = false; 
