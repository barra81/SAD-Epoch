...
// general settings
_folder = "external\service_point\"; // folder where the service point scripts are saved, relative to the mission file
...
_servicePointClasses = ["US_WarfareBVehicleServicePoint_Base_EP1", "Land_Ind_TankSmall", "Land_fuel_tank_big", "Land_fuel_tank_stairs", "Land_fuel_tank_stairs_ep1", "Land_wagon_tanker", "Land_fuelstation", "Land_fuelstation_army", "land_fuelstation_w", "Land_benzina_schnell", "FuelPump_DZ", "Land_A_FuelStation_Feed", "Land_Ind_FuelStation_Feed_EP1", "Land_FuelStation_Feed_PMC", "FuelStation", "Land_ibr_FuelStation_Feed"]; // service point classes (add "FuelPump_DZ" to use the dynamic Epoch fuel pumps)
