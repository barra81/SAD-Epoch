...
_role6 = "Server Mods";
_role6names = ["AI Missions / Patrols / Treasure Hunt", "Realistic Lift / Tow", "Custom traders / pricing", "Groupmanagment", "Trade from Vehicle", "Deploy Bike", "Barra's customs mods (see rules book", "and more..."];
_role7 = "Website";
