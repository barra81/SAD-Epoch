...
class CfgBuildingLoot {
	...
	class Military: Default {
		...
		lootType[] = {
			{ "pistols", "cfglootweapon", 0.08},
			{ "assaultrifles", "cfglootweapon", 0.25 },
			{ "sniperrifles", "cfglootweapon", 0.08 },
			{ "shotgunsingleshot", "cfglootweapon", 0.12 },
			{ "submachinegun", "cfglootweapon", 0.14 },
			{"Binocular","weapon",0.06},
			{"ItemFlashlightRed","military",0.08},
			{"ItemKnife","military",0.02},
			{"ItemGPS","weapon",0.02},
			{"ItemMap","military",0.04},
	...
	class MilitaryIndustrial: Default {
		...
		lootType[] = {
			...
			{"PartGeneric","magazine",0.06},
			{"ItemGenerator","magazine",0.02},
			{"PartWheel","magazine",0.04},
			{"Binocular","weapon",0.02},
			{"ItemFlashlightRed","military",0.06},
			{"ItemKnife","military",0.08},
			{"ItemGPS","weapon",0.02},
			...
			{"","generic",0.7},
			{"","military",0.14},
			{"ItemEtool","weapon",0.06},
			{"ItemSandbag","magazine",0.04},
			{"ItemFuelBarrelEmpty","magazine",0.06},
