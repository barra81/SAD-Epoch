...
if (!isDedicated) then {
	...
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "sys\fn_selfActions.sqf";		//Checks which actions for self
	...
	dayz_spaceInterrupt =			compile preprocessFileLineNumbers "sys\dayz_spaceInterrupt.sqf";
	...
	SafeZoneBarrels =           compile preprocessFileLineNumbers "sys\SafeZoneBarrels.sqf";
	...
	player_switchModel =		compile preprocessFileLineNumbers "sys\player_switchModel.sqf";
	...
	player_craftItem =			compile preprocessFileLineNumbers "sys\player_craftItem.sqf";
	...
	//player_build =				compile preprocessFileLineNumbers "sys\snap_build\player_build.sqf";
	...
	//ui
	player_selectSlot =			compile preprocessFileLineNumbers "sys\ui_selectSlot.sqf";
	...
	local_lockUnlock =			compile preprocessFileLineNumbers "sys\local_lockUnlock.sqf";		//When vehicle is local to unit perform locking vehicle
