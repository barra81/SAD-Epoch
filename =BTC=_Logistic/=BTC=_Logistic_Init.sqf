...
BTC_lift_max_h   = 40;
BTC_lift_radius  = 5;
BTC_Liftable     = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Air","Ship"];
BTC_Hud_Cond     = false;
...
BTC_get_liftable_array =
{
	...
	{
		case "AH6X_DZE"        : {_array = ["Motorcycle"];};
		case "MH6J_DZE"         : {_array = ["Motorcycle"];};
		case "UH1H_DZE"        : {_array = ["hilux1_civil_1_open","HMMWV_Base","Lada_base","Offroad_DSHKM_base","Pickup_PK_base","SkodaBase","UAZ_Base","VWGolf","Motorcycle","Ship"];};
		case "UH1Y_DZE"        : {_array = ["hilux1_civil_1_open","HMMWV_Base","Lada_base","Offroad_DSHKM_base","Pickup_PK_base","SkodaBase","UAZ_Base","VWGolf","Motorcycle","Ship"];};
		case "UH60M_EP1_DZE"   : {_array = ["hilux1_civil_1_open","HMMWV_Base","Ikarus","Lada_base","Offroad_DSHKM_base","Pickup_PK_base","SkodaBase","tractor","Truck","UAZ_Base","VWGolf","Motorcycle","Ship"];};
		case "MH60S_DZE"           : {_array = ["hilux1_civil_1_open","HMMWV_Base","Ikarus","Lada_base","Offroad_DSHKM_base","Pickup_PK_base","SkodaBase","tractor","Truck","UAZ_Base","VWGolf","Motorcycle","Ship"];};
		case "CH_47F_EP1_DZE"  : {_array = ["LandVehicle","Ship"];};
		case "Mi17_DZE": {_array = ["LandVehicle","Ship"];};
		case "Mi17_Civilian_DZ"        : {_array = ["LandVehicle","Ship"];};
